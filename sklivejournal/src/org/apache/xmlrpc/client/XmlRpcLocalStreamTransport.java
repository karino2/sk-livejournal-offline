...
/**
 * Another local transport for debugging and testing. This one is similar to the
 * {@link org.apache.xmlrpc.client.XmlRpcLocalTransport}, except that it adds
 * request serialization. In other words, it is particularly well suited for
 * development and testing of XML serialization and parsing.
 */
public class XmlRpcLocalStreamTransport extends XmlRpcStreamTransport {
	 ...
	 * 
	 * @param pClient
	 *            The client, which is controlling the transport.
	 * @param pServer
	 *            An instance of {@link XmlRpcStreamRequestProcessor}.
	 */
	...
	protected void writeRequest(ReqWriter pWriter) throws XmlRpcException,
		...
		pWriter.write(baos);
		XmlRpcStreamRequestConfig config = (XmlRpcStreamRequestConfig) request
				.getConfig();
		conn = new LocalStreamConnection(config, new ByteArrayInputStream(baos
				.toByteArray()));
	}
}
