...
/**
 * This is a subclass of {@link IOException}, which allows to attach a linked
 * exception. Throwing this particular instance of {@link IOException} allows to
 * catch it and throw the linked exception instead.
 */
public class XmlRpcIOException extends IOException {
	...
	/**
	 * Returns the linked exception, which is the actual cause for this
	 * exception.
	 */
