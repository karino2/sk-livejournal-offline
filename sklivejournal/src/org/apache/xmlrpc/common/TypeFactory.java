...
public interface TypeFactory {
	 ...
	 *            The request configuration.
	 * @param pContext
	 *            A namespace context, for looking up prefix mappings.
	 * @param pURI
	 *            The namespace URI of the element containing the parameter or
	 *            result.
	 * @param pLocalName
	 *            The local name of the element containing the parameter or
	 *            result.
