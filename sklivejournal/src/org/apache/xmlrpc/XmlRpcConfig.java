...
public interface XmlRpcConfig {
	/**
	 * Returns, whether support for extensions are enabled. By default,
	 * extensions are disabled and your client is interoperable with other
	 * XML-RPC implementations. Interoperable XML-RPC implementations are those,
	 * which are compliant to the <a href="http://www.xmlrpc.org/spec">XML-RPC
	 * Specification</a>.
	 * 
