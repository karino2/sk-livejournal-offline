 ...
 */
public class XmlRpcSun15HttpTransportFactory extends
	 ...
	 * 
	 * @param pClient
	 *            The client, which is operating the factory.
	 */
	 ...
	 *             if the proxyHost parameter is null or if the proxyPort
	 *             parameter is outside the range of valid port values.
	 */
	public void setProxy(String proxyHost, int proxyPort) {
		setProxy(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(proxyHost,
				proxyPort)));
	}
	...
	public XmlRpcTransport getTransport() {
		XmlRpcSun15HttpTransport transport = new XmlRpcSun15HttpTransport(
				getClient());
