...
public class XmlRpcClientConfigImpl extends XmlRpcHttpRequestConfigImpl
		implements XmlRpcHttpClientConfig, XmlRpcLocalClientConfig, Cloneable,
		Serializable {
	 ...
	 * 
	 * @param pServer
	 *            Server object being invoked. This will typically be a
	 *            singleton instance, but could as well create a new instance
	 *            with any call.
	 */
