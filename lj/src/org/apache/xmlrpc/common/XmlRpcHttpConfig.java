...
public interface XmlRpcHttpConfig extends XmlRpcStreamConfig {
	 ...
	 * into bytes.
	 * 
	 * @return Encoding being used for basic HTTP authentication credentials, or
	 *         null, if the default encoding (
	...
	/**
	 * Returns, whether a "Content-Length" header may be omitted. The XML-RPC
