...
/**
 * A common base class for {@link org.apache.xmlrpc.server.XmlRpcServer} and
...
public abstract class XmlRpcController {
	...
	/**
	 * Sets the maximum number of concurrent requests. This includes both
	...
	/**
	 * Returns the maximum number of concurrent requests. This includes both
	 * synchronous and asynchronous requests.
	 * 
	 * @return Maximum number of threads or 0 to disable the limit.
	 */
