...
public class XmlRpcHttpRequestConfigImpl extends XmlRpcConfigImpl implements
	...
	/**
	 * Sets, whether gzip compression is being used for transmitting the
	 * request.
	 * 
	 * @param pCompressing
	 *            True for enabling gzip compression, false otherwise.
	 ...
	 * 
	 * @param pRequesting
	 *            True for requesting gzip compression, false otherwise.
	...
	/**
	 * Sets, whether the response should contain a "faultCause" element in case
	 * of errors. The "faultCause" is an exception, which the server has trapped
	 * and written into a byte stream as a serializable object.
	 */
