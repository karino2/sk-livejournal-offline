...
/**
 * Extension of {@link org.apache.xmlrpc.client.XmlRpcClientConfig} for HTTP
 * based transport. Provides details like server URL, user credentials, and so
 * on.
 */
public interface XmlRpcHttpRequestConfig extends XmlRpcStreamRequestConfig,
		XmlRpcHttpConfig {
	/**
