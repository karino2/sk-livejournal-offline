...
/**
 * This exception is thrown by the XmlRpcClient, if an invocation of the remote
 * method failed. Failure may have two reasons: The invocation failed on the
 * remote side (for example, an exception was thrown within the server) or the
 * communication with the server failed. The latter is indicated by throwing an
 * instance of {@link org.apache.xmlrpc.client.XmlRpcClientException}.
 */
public class XmlRpcException extends Exception {
	...
	/**
	 * If the transport was able to catch a remote exception (as is the case, if
	 * the local transport is used or if extensions are enabled and the server
	 * returned a serialized exception), then this field contains the trapped
	 * exception.
	 */
	...
	/**
	 * Creates a new instance with the given error code, error message and
	 * cause.
	 * 
	 * @param pCode
	 *            Error code.
