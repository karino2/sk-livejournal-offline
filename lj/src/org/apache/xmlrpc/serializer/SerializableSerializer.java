...
/**
 * A {@link org.apache.xmlrpc.serializer.TypeSerializer} for instances of
...
public class SerializableSerializer extends TypeSerializerImpl {
	...
	public void write(final ContentHandler pHandler, Object pObject)
			throws SAXException {
		pHandler.startElement("", VALUE_TAG, VALUE_TAG, ZERO_ATTRIBUTES);
		pHandler.startElement("", SERIALIZABLE_TAG, EX_SERIALIZABLE_TAG,
				ZERO_ATTRIBUTES);
