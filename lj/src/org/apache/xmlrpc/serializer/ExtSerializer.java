...
public abstract class ExtSerializer implements TypeSerializer {
	 ...
	 */
	protected abstract void serialize(ContentHandler pHandler, Object pObject)
			throws SAXException;
	...
	public void write(ContentHandler pHandler, Object pObject)
		...
		pHandler.startElement("", TypeSerializerImpl.VALUE_TAG,
				...
				TypeSerializerImpl.ZERO_ATTRIBUTES);
		pHandler.startElement(XmlRpcWriter.EXTENSIONS_URI, tag, exTag,
				TypeSerializerImpl.ZERO_ATTRIBUTES);
