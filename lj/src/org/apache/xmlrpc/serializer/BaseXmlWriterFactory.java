...
/**
 * The default instance of {@link XmlWriterFactory} creates instances of
 * {@link org.apache.ws.commons.serialize.XMLWriterImpl}. This works for any
...
public class BaseXmlWriterFactory implements XmlWriterFactory {
	...
	public ContentHandler getXmlWriter(XmlRpcStreamConfig pConfig,
		...
		xw.setFlushing(true);
		try {
			xw.setWriter(new BufferedWriter(
					new OutputStreamWriter(pStream, enc)));
